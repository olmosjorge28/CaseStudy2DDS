...
spread(grouped_by_age, Attrition, n)  %>% mutate(sum = No+Yes) %>% mutate(attrition_pct = Yes/sum) %>% ggplot(aes(x = Age, y = attrition_pct)) + geom_point()
...
spread(group_by_jobSatisfaction, Attrition, n)  %>% mutate(sum = No+Yes) %>% mutate(attrition_pct = Yes/sum) %>% ggplot(aes(x = JobSatisfaction, y = attrition_pct)) + geom_point()
```
...
spread(group_by_OverTime, Attrition, n)  %>% mutate(sum = No+Yes) %>% mutate(attrition_pct = Yes/sum) %>% ggplot(aes(OverTime,attrition_pct)) + geom_col()
```
